                ...
                <div className="flex-1 overflow-y-auto p-0">
                    ...
                    {step === 'campaign' && (
                        <div className="p-4 space-y-4">
                            <SearchInput placeholder="Search campaigns..." value={searchQuery} onChange={setSearchQuery} />
                    ...
                    {step === 'customer' && (
                        <div className="p-4 space-y-4">
                            <SearchInput placeholder="Search existing customers..." value={searchQuery} onChange={setSearchQuery} />
